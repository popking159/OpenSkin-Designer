...
=====================================
[![MOD Version](https://img.shields.io/badge/MOD-v4.2.2.0-blue.svg)](#changelog)
...
OpenSkin Designer MOD by odem2014 is based on OpenSkin Designer, a further development of [e2skinner](https://code.google.com/p/e2skinner2/). This MOD continues from the stable 4.2.2.0 feature set.
...
* Designer-tree Move Up / Move Down controls for screens and items
* Designer-tree Copy / Cut / Paste between screens, including screens/panels loaded from included XML files
* Ctrl+click multi-select and group dragging in the designer preview panel
