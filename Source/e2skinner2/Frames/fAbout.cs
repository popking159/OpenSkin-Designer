    ...
    partial class fAbout : Form
    {
        public fAbout()
        {
            ...
            this.textBoxDescription.Text = AssemblyDescription + Environment.NewLine +
                ...
                "v4.2.2.0 MOD by odem2014" + Environment.NewLine +
                "- Added Move Up and Move Down buttons for selected screens and skin items" + Environment.NewLine +
                "- Screens can now be reordered from the designer tree" + Environment.NewLine +
                "- Elements/widgets/labels/pixmaps can now be reordered inside their screen" + Environment.NewLine +
                "- Right-clicking an item in the designer tree now selects and highlights it" + Environment.NewLine +
                "- Added designer-tree Copy, Cut and Paste for moving XML between screens without using the code editor" + Environment.NewLine + Environment.NewLine +
